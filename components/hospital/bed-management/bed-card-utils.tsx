import { BedStatus } from "@/lib/data/mock-floors"
...
export const bedStatusConfig: Record<BedStatus, StatusConfigEntry> = {
...
export const allowedTransitions: Partial<Record<BedStatus, BedStatus[]>> = {
