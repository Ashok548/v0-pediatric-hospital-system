...
__decorate([
    (0, class_validator_1.IsEnum)(["CONSULTATION", "LAB", "PROCEDURE", "ROOM", "MISC"], {
...
__decorate([
    ...
    (0, class_validator_1.IsNumber)({}, { message: "basePrice must be a number" }),
    (0, class_validator_1.Min)(0, { message: "basePrice must be 0 or greater" }),
...
__decorate([
    ...
    (0, class_validator_1.Max)(100, { message: "taxPercent must be between 0 and 100" }),
    __metadata("design:type", Number)
], CreateServiceDto.prototype, "taxPercent", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
