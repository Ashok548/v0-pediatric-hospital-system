...
let SettingsController = class SettingsController {
    ...
    async updateCategorySettings(category, data, changedBy) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SettingsController.prototype, "getCategorySettings", null);
__decorate([
    (0, common_1.Put)(':category'),
    __param(0, (0, common_1.Param)('category')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, common_1.Body)('changedBy')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, String]),
    __metadata("design:returntype", Promise)
], SettingsController.prototype, "updateCategorySettings", null);
