...
export const ROLE_PERMISSIONS: Record<HospitalRole, string[]> = {
    admin: ["dashboard", "patients", "nicu", "appointments", "admissions", "beds", "lab", "billing", "vaccination", "reports", "settings", "nursing", "pharmacy"],
...
// ─── State ────────────────────────────────────────────────────────────────────
let _currentUser: MockUser = MOCK_USERS[0] // Default: Doctor
