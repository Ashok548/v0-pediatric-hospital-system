...
file_path = "c:\\Users\\Rupa\\Documents\\Ashok Projects\\v0-pediatric-hospital-system\\apps\\web\\components\\hospital\\appointments-content.tsx"
...
# 12. Appt length and filtered length references
# (since appts comes from SWR now, we just ensure the appts array handles missing)

# 13. Replace doctor tabs "doctors" with "apiDoctors"
content = content.replace(
    '{doctors.map(d => (',
    '{apiDoctors.map(d => ('
)
